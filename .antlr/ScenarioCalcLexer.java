...
public class ScenarioCalcLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SCENARIO", "GIVEN", "CALCULATE", "REPORT", "IF", "THEN", "ELSE", "END", 
			"AS", "TRUE", "FALSE", "PLUS", "MINUS", "STAR", "DIV", "CARET", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "SEMI", "COMMA", "ASSIGN", "EQ", "NEQ", 
			"GT", "LT", "GTE", "LTE", "AND", "OR", "NOT", "STRING", "NUMBER", "ID", 
			"WS", "LINE_COMMENT", "BLOCK_COMMENT", "DIGIT"
		};
	}
	...
	public ScenarioCalcLexer(CharStream input) {
		super(input);
